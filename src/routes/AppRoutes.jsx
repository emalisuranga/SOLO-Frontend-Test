...
const EmployeeRestoration = lazy(() => import('../Page/Settings/EmployeeRestoration/EmployeeRestoration'));
  ...
  <ErrorBoundary>
    <Suspense fallback={<div>Loading...</div>}>
      <Routes>
        ...
        <Route path="/settings/employee-restoration" element={<EmployeeRestoration />} />
      </Routes>
    </Suspense>
   </ErrorBoundary>
);
